...
// import fe.linksheet.module.resolver.urlresolver.amp2html.Amp2HtmlUrlResolver // Removed - no backend connectivity
import fe.linksheet.module.resolver.urlresolver.StubAmp2HtmlUrlResolver
import fe.linksheet.module.resolver.urlresolver.base.ResolvePredicate
// import fe.linksheet.module.resolver.urlresolver.redirect.RedirectUrlResolver // Removed - no backend connectivity
import fe.linksheet.module.resolver.urlresolver.StubRedirectUrlResolver
...
import fe.linksheet.module.http.StubUnfurler
...
class ImprovedIntentResolver(
    ...
    private val redirectUrlResolver: StubRedirectUrlResolver,
    private val amp2HtmlResolver: StubAmp2HtmlUrlResolver,
    ...
    private val unfurler: StubUnfurler,
...
//    }
    ...
    override suspend fun resolve(intent: SafeIntent, referrer: Uri?): IntentResolveResult = coroutineScope scope@{
        ...
        val canAccessInternet = networkStateService.isNetworkConnected.value
