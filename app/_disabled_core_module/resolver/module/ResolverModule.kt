...
// Original URL resolvers removed - no backend connectivity needed
...
val ResolverModule = module {
    ...
    // Stub URL resolvers - no backend connectivity needed
    single { StubRedirectUrlResolver() }
    single { StubAmp2HtmlUrlResolver() }
