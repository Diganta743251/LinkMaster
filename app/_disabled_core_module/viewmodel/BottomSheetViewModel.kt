...
class BottomSheetViewModel(
    ...
    // experimentRepository: ExperimentRepository, // Removed - violates Play Store policies
    ...
    // Experiment features removed - violates Play Store policies
    // Using default values for better user experience
    val improvedBottomSheetExpandFully = preferenceRepository.asViewModelState(AppPreferences.enableBottomSheetExpandFully)
    val improvedBottomSheetUrlDoubleTap = preferenceRepository.asViewModelState(AppPreferences.enableBottomSheetUrlDoubleTap)
    val interceptAccidentalTaps = preferenceRepository.asViewModelState(AppPreferences.enableInterceptAccidentalTaps)
    val manualFollowRedirects = preferenceRepository.asViewModelState(AppPreferences.enableManualFollowRedirects)
    val noBottomSheetStateSave = preferenceRepository.asViewModelState(AppPreferences.disableBottomSheetStateSave)
    val expressiveLoadingSheet = preferenceRepository.asViewModelState(AppPreferences.enableExpressiveLoadingSheet)
